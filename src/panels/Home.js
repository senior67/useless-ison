...
import { Panel, PanelHeader, Button, Group, Div, Text } from '@vkontakte/vkui';
	...
	<Panel id={id}>
		...
		<Group title="Navigation Example">
			<Div>
				...
				<Button size="xl" level="2" onClick={() => bridge.send("VKWebAppShowWallPostBox", {"message": "Я опубликовал это с помощью VK Mini App!"})}>
