...
import { Panel, PanelHeader, Button, Group, Div, Card, CardGrid, Text } from '@vkontakte/vkui';
				...
				<Group separator="hide" header={<Header mode="secondary">#СамыйГлупыйЧеллендж</Header>}>
					<CardGrid>
						<Card size="l" mode="shadow">
							<center><Text weight="regular">Это приложение - из серии приложений «Senior Useless» (сеньор бесполезен). В данном приложении вы можете узнать, включено ли устройство, с которого вы посещаете наше приложение.</Text><br /><br /><Text weight="medium">Мы запускаем челлендж - опубликуйте на своей стене ВКонтакте предложенный ниже пост, чтобы сказать всем, что Ваше устройство включено, а также дайте возможность вашим друзьям проверить статус вашего устройства!</Text>
